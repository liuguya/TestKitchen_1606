...
import UIKit
//屏幕的宽度和高度
public let kSreenWith = UIScreen.mainScreen().bounds.size.width

public let kSreenHeight = UIScreen.mainScreen().bounds.size.height
...
//广告分享
//methodName=AppShare&shareID=&shareModule=course&token=&user_id=&version=4.5

//评论
public let kHostUrl = "http://api.izhangchu.com/?appVersion=4.5&sysVersion=9.3.2&devModel=iPhone"
//methodName=CommentList&page=1&relate_id=22&size=10&token=&type=2&user_id=&version=4.5
